...
/usr/opt/cross/bin/i686-elf-gcc -static -fno-pie -I./include -nostdlib -O0 -w -mgeneral-regs-only -c kernel/hw/i8042/i8042.c -o i8042.o
# /usr/opt/cross/bin/i686-elf-gcc -static -fno-pie -I./include -nostdlib -c kernel/arch/i386/gdt.c -o gdt.o
/usr/opt/cross/bin/i686-elf-ld main.o vga.o interrupts.o gdt.o i8259.o i8042.o -e main -o main
