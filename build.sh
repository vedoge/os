...
/usr/opt/cross/bin/i686-elf-gcc -static -fno-pie -I./include -nostdlib -mgeneral-regs-only -c kernel/main.c -o main.o
/usr/opt/cross/bin/i686-elf-gcc -static -fno-pie -I./include -nostdlib -c kernel/drivers/vga/vga.c -o vga.o
/usr/opt/cross/bin/i686-elf-gcc -static -fno-pie -I./include -nostdlib -c kernel/drivers/i8259/i8259.c -o i8259.o
...
/usr/opt/cross/bin/i686-elf-ld main.o vga.o interrupts.o gdt.o i8259.o -e main -o main
